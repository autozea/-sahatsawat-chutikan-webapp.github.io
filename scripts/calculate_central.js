...
fetch("https://covid19.ddc.moph.go.th/api/Cases/today-cases-by-provinces")
  ...
  .then((data) => {
    ...
    let date_update_day;
    data.forEach((central_name) => {
      if (list_central_name.includes(central_name.province)) {
        var date_update = document.getElementById("date_update");
        date_update_day = ": " + central_name.update_date + " น.";
        ...
        sum_total_case += central_name.total_case;
        ...
        sum_today_death += central_name.new_death;
        ...
        sum_total_death += central_name.total_death;
        ...
        new_case_excludeabroad += central_name.new_case_excludeabroad;
...
ul.onclick = function (event) {
  ...
  goback.href = "./region-central.html";
