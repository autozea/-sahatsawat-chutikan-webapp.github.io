...
fetch("https://covid19.ddc.moph.go.th/api/Cases/today-cases-by-provinces")
  ...
  .then((data) => {
    ...
    let date_update_day;
    data.forEach((northeast_name) => {
      // console.log(array.includes(northeast_name));
      if (list_northeast_name.includes(northeast_name.province)) {
        var date_update = document.getElementById("date_update");
        date_update_day = ": " + northeast_name.update_date + " น.";
        ...
        sum_total_case += northeast_name.total_case;
        ...
        sum_today_death += northeast_name.new_death;
        ...
        sum_total_death += northeast_name.total_death;
        ...
        new_case_excludeabroad += northeast_name.new_case_excludeabroad;
...
ul.onclick = function (event) {
  ...
  goback.href = "./region-northeast.html";
