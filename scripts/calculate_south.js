  ...
  .then((data) => {
    ...
    data.forEach((south_name) => {
      ...
      if (list_south_name.includes(south_name.province)) {
        ...
        date_update_day = ": " + south_name.update_date + " น.";
        ...
        check_today_case += south_name.new_case;
        ...
        new_case_excludeabroad += south_name.new_case_excludeabroad;
