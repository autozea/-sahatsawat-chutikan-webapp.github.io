...
fetch("https://covid19.ddc.moph.go.th/api/Cases/today-cases-by-provinces")
  ...
  .then((data) => {
    ...
    let date_update_day;
    data.forEach((easten_name) => {
      // console.log(array.includes(easten_name));
      if (list_easten_name.includes(easten_name.province)) {
        var date_update = document.getElementById("date_update");
        date_update_day = ": " + easten_name.update_date + " น.";
        ...
        sum_total_case += easten_name.total_case;
        ...
        sum_today_death += easten_name.new_death;
        ...
        sum_total_death += easten_name.total_death;
        ...
        new_case_excludeabroad += easten_name.new_case_excludeabroad;
...
ul.onclick = function (event) {
  ...
  goback.href = "./region-easten.html";
